...
import { faBullhorn, faClock, faHeart, faLocationDot, faShareNodes, faStar } from '@fortawesome/free-solid-svg-icons'
import { CURRENCY_SYMBOL } from '@/utils/constant'

const DesktopRestaurantDetailsBox = ({RestaurantIcon, RestaurantName, RestaurantAddress, Restaurant_Delevery_In, Restaurant_Start_From, RestaurantDistance, RestaurantRating }) => {
  return (
                ...
                <div className="relative w-[75%] place-self-end overflow-hidden">
                  <div className="flex whitespace-nowrap animate-marquee">
                    <p className="mr-8">
                      ...
                      Accusantium tempora ipsum, omnis explicabo optio nostrum
                      non error eaque libero excepturi consequuntur asperiores
                      natus dolorum fuga. Ea debitis sit ullam sapiente?
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-between">
                  <div className="flex justify-between">
                    <div>
                      ...
                      <p className="text-gray-500">{RestaurantAddress}</p>
